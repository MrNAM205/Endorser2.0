...
import CognitionCockpit from './components/CognitionCockpit'; // Import the new component
import './App.css';
...
function App() {
  ...
  const renderView = () => {
    switch (currentView) {
      ...
      case 'cognition-cockpit': // Add a case for the new view
        return <CognitionCockpit />;
      default:
        return <Dashboard />;
    }
  };
    ...
    <div className={`app-container ${theme}-mode`}>
      <div className="sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <a href="#" onClick={() => setCurrentView('cognition-cockpit')} className={currentView === 'cognition-cockpit' ? 'active' : ''}>Cognition Cockpit</a>
        </nav>
